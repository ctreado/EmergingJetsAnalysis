...
#runEJsHistogrammer.py --inDir ${input_local}   --outDir ${output_local}   --inTags ${intags_data17} --mergeDatasets --renameAndMove
...
#runEJsHistogrammer.py --inDir ${input_bench}      --outDir ${output_test} --inTags ${intags_data17} --mergeDatasets --renameAndMove --nevents -1
#runEJsHistogrammer.py --inDir ${input_grid_lxp_c} --outDir ${output_test} --inTags ${intags_08}     --mergeDatasets --renameAndMove --nevents 1000
...
#runEJsHistogrammer.py --inDir ${input_grid_lxp_k} --outDir ${output_test} --inTags ${intags_75}     --mergeDatasets --renameAndMove --nevents 1000
#runEJsHistogrammer.py --inDir ${input_grid_lxp_o} --outDir ${output_test} --inTags ${intags_bkgd}   --mergeDatasets --renameAndMove --nevents 1000
