...
#submitLocalEJsJobs.py --inFiles ${input_d} --jo ${jo_d} --nevents 100 --isMC --move --delete

# job steering -- pythia di-jet background
#submitLocalEJsJobs.py --inFiles ${input_bkgd_d} --jo ${jo_d} --nevents 100 --isMC --move --delete


## trigger study
jo_d_trig="$EJ_PATH/EJsAnalysis/config/EJsConfig_trig_mc16d.py"
tag_trig="latest-trigger"
#submitLocalEJsJobs.py --inFiles ${input_d} --jo ${jo_d_trig} --nevents -1 --isMC --outTag ${tag_trig} --move --delete
#submitLocalEJsJobs.py --inFiles ${input_bkgd_d} --jo ${jo_d_trig} --nevents -1 --isMC --outTag ${tag_trig} --move --delete
