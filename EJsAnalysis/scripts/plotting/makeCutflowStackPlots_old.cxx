			     ...
			     Bool_t  doLogy = true,     Bool_t  doNorm = true,            Bool_t  doLocal = true )
{
  ...
  if ( htype.Contains("mc16d" ) ) {
	...
	hpath = "tree/local.MC16d.oldoff/data-cutflow/";
	...
	hpath = "tree/local.MC16d.updatetest/data-cutflow/";
	//fname.push_back( "999999.EJ_ModelA_1000_150_4TJF_update.r10739.exot23.root" );
	fname.push_back( "999999.EJ_ModelB_1000_5_4TJF_update.r10739.exot23.root" );
	//fname.push_back( "310328.EJ_ModelA_1000_150_4TJF_update.r10739.exot23.root" );
	fname.push_back( "310346.EJ_ModelB_1000_5_4TJF_update.r10739.exot23.root" );
	//lname.push_back( "A_1000_150_999999" );
	lname.push_back( "B_1000_5_999999"   );
	//lname.push_back( "A_1000_150_310328" );
	lname.push_back( "B_1000_5_310346"   );
      }
    }
  }
