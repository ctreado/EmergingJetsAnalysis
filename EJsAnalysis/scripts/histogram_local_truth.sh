...
output_81="$EJ_PATH/../output/localOutput/truth_fix-vs-run_test/"

runEJsHistogrammer.py --inDir ${input_81} --outDir ${output_81} --jo ${jo} --renameAndMove --mergeDatasets --inTags "B,run"
